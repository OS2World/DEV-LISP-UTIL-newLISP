/* nl-protos.h function prototypes fo6 newLISP */
CELL * appendArray(CELL * cell, CELL * params);
CELL * appendNode(CELL * node, CELL * newNode);
CELL * appendString(CELL * cell, CELL * params, char * joint, size_t jointLen, int evalFlag);
...
CELL * evalCheckProtected(CELL * cell, CELL * * sPtr);
...
CELL * evaluateMacro(CELL * macro, CELL * arg, SYMBOL * newContext);
...
CELL * updateCell(CELL * cell, CELL * new);
...
CELL * sysEvalString(char * str, CELL * errorProc, SYMBOL * context);
CELL * whileUntil(CELL * params, int whileUntilFlag);
CELL * writeProcess(char * command, char * inp);
...
void recoverEnvironment(int idx);
